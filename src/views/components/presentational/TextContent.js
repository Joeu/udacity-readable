...
const Comment = (props) => {
  const handleVoteUpdate = (option) =>{
    props.updateVoteScore(props.post.id, option);
  }
      ...
      <Media as='li'>
          ...
          <Media.Body>
            ...
            <div className='post-button-control'>
              ...
              <button className='btn' onClick={() => handleVoteUpdate('voteUp')}><i className='fas fa-thumbs-up'></i></button>
              <button className='btn' onClick={() => handleVoteUpdate('voteDown')}><i className='fas fa-thumbs-down'></i></button>
